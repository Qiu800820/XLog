...
public class XLogConfiguration{
    ...
    public static final String DEFAUL_FILE_LOG_DIR_NAME  = "Xlog";
	...
	/**
	 * 当日志文件有crash信息输入时，将该文件上传到哪个服务器
	 */
	private String crashFileUploadTo;
	
	/**
	 * 是否开启crashHandler ,如果不开启的话不会讲crash日志写入到文件
	 */
	...
	public XLogConfiguration(Builder builer){
	    ...
	    this.crashFileUploadTo = builer.crashFileUploadTo;
    ...
    public String getCrashFileUploadTo()
    {
        return crashFileUploadTo;
    }
    ...
    public static class Builder{
	     ...
	     * @param 原始异常处理类 {@link UncaughtExceptionHandler}
	     */
	    ...
	    /**
	     * 设置Crash用户上传日志信息
	     * @param 用户上传事件{@link OnUpdateCrashInfoListener}
	     */
	    ...
	    /**
	     * 设置当日志文件有crash信息写入时上传到哪个服务器
	     * @param url 服务器的目标地址
	     * @return
	     */
	    public Builder setCrashUploadTo(String url){
	        this.crashFileUploadTo = url;
	        return this;
	    }
	    ...
	    private void checkNullFiled(){
	        ...
	        if(null == crashFileUploadTo){
	            crashFileUploadTo = STRING_NULL;
	        }
	    ...
	    private String getDefaultFileLogDirName(Context mContext)
	    {
	        ...
	        return DEFAUL_FILE_LOG_DIR_NAME;
	    }
